...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfWork())
    {
        ...
        if (vtx[0].vout[0].nValue < GetProofOfWorkReward(nFees) * 0.25 / 100)
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SpecialCoin";
        CTransaction txNew;
        txNew.nTime = 1401374444;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("d94bc62664a42d969cdfbfb18a46164cb743929bd164dcbe12eedc4265240f8a"));
        block.print();
